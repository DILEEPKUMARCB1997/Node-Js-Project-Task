...
//  const { deviceListArray, onlineArrayDeviceList } =cisco
...
const server = net.createServer((socket) => {
  ...
  socket.on("end", () => {
    console.log("SNMP socket closed");
  });
});

server.listen(PORT, () => {
  console.log(`SNMP trap server listening on port ${PORT}`);
});
